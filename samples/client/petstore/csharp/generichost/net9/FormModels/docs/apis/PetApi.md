...
namespace Example
{
    public class FindPetsByStatusExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PetApi(config);
            var status = new List<FindPetsByStatusStatusParameterInner>(); // List<FindPetsByStatusStatusParameterInner> | Status values that need to be considered for filter
